...
//   $('#date-2').datepicker();
        ...
        /*-- Easy Pie Chart --*/
        $('#consulationChart').data('easyPieChart').options.barColor = '#40CCB1';
        $('#consulationChart').data('easyPieChart').options.width = '130px';
        $('#diagnosticChart').data('easyPieChart').options.barColor = '#FEB777';
