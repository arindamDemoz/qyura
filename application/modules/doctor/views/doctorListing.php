               ...
               <div id="sidebar-menu">
                  <ul>
                     ...
                     <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                           <li class="active"><a href="<?php echo base_url();?>index.php/doctor">All Doctors</a></li>
                           <li><a href="<?php echo base_url();?>index.php/doctor/addDoctor">Add New Doctor</a></li>
                        ...
                        <form>
                           ...
                           <aside class="col-md-3 col-sm-3 m-tb-xs-3">
                              <!--<select type="text" name="search" class="selectpicker" data-width="100%"  placeholder="Search" />-->
                                 ...
                                 <?php print_r($speciality); foreach($speciality as $key=>$val) {?>
