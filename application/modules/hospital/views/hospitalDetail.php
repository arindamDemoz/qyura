                            ...
                            <section class="col-md-12">
                                ...
                                <article class="text-center clearfix m-t-50">
                                    <ul class="nav nav-tab nav-setting">
                                        ...
                                        <li class=" ">
                                            <a data-toggle="tab" href="#sp">Staff & Permission</a>
                                        </li>
                                        -->
                                        <li class=" ">
                                                                ...
                                                                <div class="col-md-8 col-sm-8">
                                                                    ...
                                                                    <aside class="row">
                                                                        ...
                                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-10 m-t-xs-10">
                                                                            <input type="text" class="form-control" name="hospital_phn[]" id="hospital_phn<?php echo $i;?>" placeholder="9837000123" value="<?php echo $moreExpolde[1];?>" maxlength="10" onblur="checkNumber(<?php echo $i;?>)"/>
                                                                        </div>
