                ...
                <!--- Divider -->
                  <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            <a class="waves-effect active" href="#"><i class="fa fa-ambulance"></i> 
                            <span>Ambulance Providr</span><span class="pull-right"><i class="md md-add"></i></span></a>
                            <ul class="list-unstyled">
                                <li class="active"><a href="<?php echo base_url();?>index.php/ambulance">All Ambulance Providers</a></li>
                            ...
                            <article class="clearfix m-top-40 p-b-20">
                                ...
                                <table class="table all-bloodbank">
                                    <tbody>
                                        ...
                                        <?php foreach($ambulanceData as $key => $val){ ?>
                                        <tr>
                                            <td>
                                                
                                             <?php if(!empty($val->ambulance_img)){?>
                                                <h6><img src="<?php echo base_url()?>assets/ambulanceImages/<?php echo $val->ambulance_img; ?>" alt="" class="img-responsive" height="80px;" width="80px;"" /></h6>
                                               <?php } else { ?>
                                                 <h6><img src="<?php echo base_url()?>assets/images/noImage.png" alt="" class="img-responsive" height="80px;" width="80px;"/></h6>
                                               <?php } ?>
                                            </td>
                                            <td>
                                                <h6><?php echo $val->ambulance_name?></h6>
                                            ...
                                            <td><h6><?php echo $val->city_name;?></h6></td>
                                             <td>
                                                 <?php 
                                                $explode= explode('|',$val->ambulance_phn); 
                                            ...
                                            <td>
                                                <h6><?php echo $val->ambulance_address;?></h6>
                                            ...
                                            <td>
                                                <h6><a href="<?php echo base_url()?>index.php/ambulance/detailAmbulance/<?php echo $val->ambulance_id;?>" class="btn btn-warning waves-effect waves-light m-b-5 applist-btn" >View Detail</a></h6>
