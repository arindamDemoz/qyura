                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="<?php echo base_url();?>index.php/ambulance/addAmbulance">Add Ambulance Provider</a></li>
                            </ul>
                        </li>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="map_canvas"></div>
                     <form class="cmxform form-horizontal tasi-form" id="ambulanceForm" name="ambulanceForm" method="post" action="<?php echo site_url(); ?>/ambulance/SaveAmbulance" novalidate="novalidate" enctype="multipart/form-data" >
                                    ...
                                    <aside class="col-md-8">
                                        <div class="clearfix m-t-20 p-b-20">
                                            ...
                                            <aside class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 m-t-xs-10">
                                                    <input type="text" class="form-control" id="ambulance_zip" name="ambulance_zip" placeholder="700001" maxlength="13" />
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                           <aside class="row clone">
                                                ...
                                                <div class="col-lg-7 col-md-6 col-sm-7 col-xs-10 m-t-xs-10" >
                                                    <input type="text" class="form-control" name="users_mobile" id="users_mobile" placeholder="9837000123" maxlength="10" />
