...
<!--                                <span class="clear"> 
                    ...
                    <?php foreach ($servicesArray as $service){ ?> 
                        <li class="<?php echo ($this->uri->segment(1)=="superadmin" &&  $this->uri->segment(4)=="aerobics") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("vendorview/vendorCustomView")."/aerobics"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label"><?php echo $service->serviceName; ?></span></a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
