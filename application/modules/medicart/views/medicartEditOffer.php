...
<!--                                                    <input id="uploadBtn12" type="file" class="upload123" />-->
                                                ...
                                                <img src="<?php if(!empty($offerData->medicartOffer_image)):echo base_url().$offerData->medicartOffer_image; else: echo base_url().'assets/images/noImage.png'; endif; ?>" alt=" " class="img-responsive image-preview-show" width="180"/>
