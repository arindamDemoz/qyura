                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="icheck-inline">
                                            ...
                                            <input type="checkbox" value="Acrobatic" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Acrobatic", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities1" class="multiCheckbox">
                                            <label>Acrobatic</label>
                                            
                                            <input type="checkbox" value="Belle" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Belle", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities2" class="multiCheckbox">
                                            <label>Belle</label>
                                            
                                            <input type="checkbox" value="Ballroom" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Ballroom", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities3" class="multiCheckbox">
                                            <label>Ballroom</label>
                                            
                                            <input type="checkbox" value="Belly" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Belly", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities4" class="multiCheckbox">
                                            <label>Belly</label>
                                            
                                            <input type="checkbox" value="Bharatnatyam" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Bharatnatyam", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities5" class="multiCheckbox">
                                            <label>Bharatnatyam</label>
                                            
                                            <input type="checkbox" value="Break dance" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Break dance", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities6" class="multiCheckbox">
                                            <label>Break dance</label>
                                            
                                            <input type="checkbox" value="Cha Cha" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Cha Cha", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities7" class="multiCheckbox">
                                            <label>Cha Cha</label>
                                            
                                            <input type="checkbox" value="Classical" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Classical", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities8" class="multiCheckbox">
                                            <label>Classical</label>
                                            
                                            <input type="checkbox" value="Choreography" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Choreography", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities9" class="multiCheckbox">
                                            <label>Choreography</label>
                                            
                                            <input type="checkbox" value="Contemporary" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Contemporary", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities10" class="multiCheckbox">
                                            <label>Contemporary</label>
                                            
                                            <input type="checkbox" value="Dandiya" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Dandiya", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities11" class="multiCheckbox">
                                            <label>Dandiya</label>
                                            
                                            <input type="checkbox" value="Folk" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Folk", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities12" class="multiCheckbox">
                                            <label>Folk</label>
                                            
                                            <input type="checkbox" value="Free Style" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Free Style", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities13" class="multiCheckbox">
                                            <label>Free Style</label>
                                            
                                            <input type="checkbox" value="Fusion" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Fusion", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities14" class="multiCheckbox">
                                            <label>Fusion</label>
                                            
                                            <input type="checkbox" value="Garba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Garba", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities15" class="multiCheckbox">
                                            <label>Garba</label>
                                            
                                            <input type="checkbox" value="Hip Hop" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Hip Hop", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities16" class="multiCheckbox">
                                            <label>Hip Hop</label>
                                            
                                            <input type="checkbox" value="Jazz" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Jazz", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities17" class="multiCheckbox">
                                            <label>Jazz</label>
                                            
                                            <input type="checkbox" value="Jive" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Jive", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities18" class="multiCheckbox">
                                            <label>Jive</label>
                                            
                                            <input type="checkbox" value="Kathak" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Kathak", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities19" class="multiCheckbox">
                                            <label>Kathak</label>
                                            
                                            <input type="checkbox" value="Kathakali" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Kathakali", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities20" class="multiCheckbox">
                                            <label>Kathakali</label>
                                            
                                            <input type="checkbox" value="Kuchipudi" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Kuchipudi", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities21" class="multiCheckbox">
                                            <label>Kuchipudi</label>
                                            
                                            <input type="checkbox" value="Latin" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Latin", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities22" class="multiCheckbox">
                                            <label>Latin</label>
                                            
                                            <input type="checkbox" value="Latin American" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Latin American", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities23" class="multiCheckbox">
                                            <label>Latin American</label>
                                            
                                            <input type="checkbox" value="Odissi" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Odissi", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities24" class="multiCheckbox">
                                            <label>Odissi</label>
                                            
                                            <input type="checkbox" value="Pole" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Pole", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities25" class="multiCheckbox">
                                            <label>Pole</label>
                                            
                                            <input type="checkbox" value="Rock n roll" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Rock n roll", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities26" class="multiCheckbox">
                                            <label>Rock n roll</label>
                                            
                                            <input type="checkbox" value="salsa" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("salsa", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities27" class="multiCheckbox">
                                            <label>salsa</label>
                                            
                                            <input type="checkbox" value="Tango" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Tango", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities28" class="multiCheckbox">
                                            <label>Tango</label>
                                            
                                            <input type="checkbox" value="Tap" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Tap", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities29" class="multiCheckbox">
                                            <label>Tap</label>
                                            
                                            <input type="checkbox" value="Waltz" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Waltz", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities30" class="multiCheckbox">
                                            <label>Waltz</label>
                                            
                                            <input type="checkbox" value="Western" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Western", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities31" class="multiCheckbox">
                                            <label>Western</label>
