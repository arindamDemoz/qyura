                        ...
                        <article class="row p-b-10">
                            <form>
                                <aside class="col-md-2 col-sm-2">
                                    <a title="Add Appointment" href="addappointment.html" class="btn btn-appointment waves-effect waves-light"><i class="fa fa-plus"></i> Add</a>
                                </aside>
                            ...
                            <article class="tab-content">
                                ...
                                <section id="consulting" class="tab-pane fade in active sa-cons">
                                    <aside class="table-responsive">
                                        <table class="table applist-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p> <a class="btn btn-warning waves-effect waves-light m-b-5 applist-btn" href="mi-cons-appointment-detail.html">View Detail</a></p>
                                                        <button type="button" class="btn btn-success waves-effect waves-light m-b-5 applist-btn">Change Timing</button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p> <a class="btn btn-warning waves-effect waves-light m-b-5 applist-btn" href="mi-cons-appointment-detail.html">View Detail</a></p>
                                                        <button disabled="disabled" type="button" class="btn btn-success waves-effect waves-light m-b-5 applist-btn">Change Timing</button>
                                                    </td>
                                                </tr>
                                ...
                                <section id="diagnostic" class="tab-pane fade in sa-cons">
                                    <aside class="table-responsive">
                                       ...
                                       <table class="table diagnostic-table" id="datatable_bloodbank">
