...
class DiagonsticCenter_models extends CI_Model {
    ...
    function diaginsticList($lat, $long, $notIn, $isemergency, $radius, $rating, $isHealtPkg, $isConsulting){
        ...
        $this->db->select('diagnostic_usersId userId,qyura_diagnostic.diagnostic_id as id, diagnostic_deleted as fav, diagnostic_deleted as rat, diagnostic_address adr,diagnostic_name name,diagnostic_phn phn, diagnostic_lat lat, diagnostic_long long, qyura_diagnostic.modifyTime upTm, diagnostic_img imUrl, (
