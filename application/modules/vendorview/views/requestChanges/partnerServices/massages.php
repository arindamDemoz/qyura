                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="massId" id="massId" value="<?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->tableAutoincrementId;endif;?>">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="item" id="item" class="t-f-full form-control" ><?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->item;endif;?></textarea>
