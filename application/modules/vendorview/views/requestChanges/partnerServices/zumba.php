                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="zumbaId" id="zumbaId" value="<?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->tableAutoincrementId;endif;?>">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-lg-12">
				...
				<?php if(isset($serviceData) && !empty($serviceData)):
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="icheck-inline">
                                            ...
                                            <input type="checkbox" value="Zumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Zumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories1" class="multiCheckbox">
                                            <label>Zumba</label>
                                                
                                            <input type="checkbox" value="aquaZumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("aquaZumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories2" class="multiCheckbox">
                                            <label>Aqua Zumba</label>
                                                
                                            <input type="checkbox" value="stepZumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("stepZumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories3" class="multiCheckbox">
                                            <label>Step Zumba</label>
                                                
                                            <input type="checkbox" value="goldZumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("goldZumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories4" class="multiCheckbox">
                                            <label>Gold Zumba</label>
                                                
                                            <input type="checkbox" value="toningZumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("toningZumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories5" class="multiCheckbox">
                                            <label>Toning Zumba</label>
                                                
                                            <input type="checkbox" value="sentaoZumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("sentaoZumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories6" class="multiCheckbox">
                                            <label>Sentao Zumba</label>
                                            
                                            <input type="checkbox" value="kidsZumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("kidsZumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories7" class="multiCheckbox">
                                            <label>Kids Zumba</label>
                                            
                                            <input type="checkbox" value="circuitZumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("circuitZumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories8" class="multiCheckbox">
                                            <label>Circuit Zumba</label>
                                            
                                            <input type="checkbox" value="zumbiniZumba" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("zumbiniZumba", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories9" class="multiCheckbox">
                                            <label>Zumbini</label>
                            ...
                            <div class="col-md-6"> 
                                <div>
                                    ...
                                    <div class="col-lg-5"><label  for="typehead">Zumba Charges *</label></div>
