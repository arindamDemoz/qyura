                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="swimId" id="swimId" value="<?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->tableAutoincrementId;endif;?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="male_Div">
                                                <div class="col-md-12" id="maleSlotDiv_1">
                                                    <div class="col-md-2 timeSlotClass" >
                                                        <input type="checkbox" name="timeSlotN" id="maleC" onclick="customShowDays('maleC', 'maleStartTime_1','maleEndTime_1','male')" <?php if(isset($male[0]) && !empty($male[0]) && isset($male[1]) && !empty($male[1])):echo"checked";endif;?>/> Male
                                            ...
                                            <div id="female_Div">
                                                <div class="col-md-12 m-top-10" id="femaleSlotDiv_1">
                                                    <div class="col-md-2 timeSlotClass" >
                                                        <input type="checkbox" name="timeSlotN" id="femaleC" onclick="customShowDays('femaleC', 'femaleStartTime_1','femaleEndTime_1','female')" <?php if(isset($female[0]) && !empty($female[0]) && isset($female[1]) && !empty($female[1])):echo"checked";endif;?>/> Female
                                            ...
                                            <div id="kids_Div">
                                                <div class="col-md-12 m-top-10" id="kidsSlotDiv_1">
                                                    <div class="col-md-2 timeSlotClass" >
                                                        <input type="checkbox" name="timeSlotN" id="kidsC" onclick="customShowDays('kidsC', 'kidsStartTime_1','kidsEndTime_1','kids')" <?php if(isset($kids[0]) && !empty($kids[0]) && isset($kids[1]) && !empty($kids[1])):echo"checked";endif;?>/> Kids
                                            ...
                                            <div class="col-md-12  m-top-10">
                                                <div class="col-md-2">
                                                  <input type="checkbox" name="timeSlotN" id="commonC" onclick="customShowDays('commonC', 'day13','day14')" <?php if(isset($common[0]) && !empty($common[0]) && isset($common[1]) && !empty($common[1])):echo"checked";endif;?>/> Common
                                                </div>
                                                <div class="col-md-3" data-autoclose="true">
                                                    <div class="bootstrap-timepicker input-group">
                            ...
                            <div class="col-md-12"> 
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5"><label  for="typehead">Swimming Charges *</label></div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4 charges"><input type="checkbox" name="chargeType[]" id="perSession" onclick="customShow('perSession', 'perSessionDiv')" value="per_hour" <?php if(isset($chargeType) && !empty($chargeType)):if(in_array("per_hour", $chargeType)):echo"checked";endif;endif;?>/> Per Hour </div>

                                        <div class="col-md-8 <?php if(isset($chargeType) && !empty($chargeType)):if(!in_array("per_hour", $chargeType)):echo"customHide";endif;else: echo 'customHide';endif;?>" id="perSessionDiv" >
                                            <div class="col-md-6">
                                                <input maxlength="100" id="perSessionText" tabindex="1" class="form-control" type="text" name="chargeAmount[]" placeholder="&#8377; 00.00" value="<?php if(isset($chargeType) && !empty($chargeType)):if(array_key_exists("per_hour", $chargeAmount)):echo $chargeAmount['per_hour'];endif;endif;?>" onkeypress="return isNumberKey(event,'chargesErr')">
                                            </div>
                                            <div class="col-md-6">
                                                <input maxlength="100" id="discHourText" tabindex="1" class="form-control" type="text" name="discAmount[]" placeholder="%" value="<?php if(isset($chargeType) && !empty($chargeType)):if(array_key_exists("per_hour", $discAmount)):echo $discAmount['per_hour'];endif;endif;?>" onkeypress="return isNumberKey(event,'chargesErr')">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12  m-top-10">
                                        ...
                                        <div class="col-md-8 <?php if(isset($chargeType) && !empty($chargeType)):if(!in_array("Weekly", $chargeType)):echo"customHide";endif;else: echo 'customHide';endif;?>" id="perVisitDiv">
                                            <div class="col-md-6">
                                                <input maxlength="50" id="perVisitText" tabindex="1" class="form-control" type="text" name="chargeAmount[]" placeholder="&#8377; 00.00" value="<?php if(isset($chargeType) && !empty($chargeType)):if(array_key_exists("Weekly", $chargeAmount)):echo $chargeAmount['Weekly'];endif;endif;?>" onkeypress="return isNumberKey(event,'chargesErr')">
                                            </div>
                                            <div class="col-md-6">
                                                    <input maxlength="50" id="discWeekText" tabindex="1" class="form-control" type="text" name="discAmount[]" placeholder="%" value="<?php if(isset($chargeType) && !empty($chargeType)):if(array_key_exists("Weekly", $discAmount)):echo $discAmount['Weekly'];endif;endif;?>" onkeypress="return isNumberKey(event,'chargesErr')">
                                            </div>
                                        </div>
                                    </div>
