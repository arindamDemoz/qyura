                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="aboutUs" id="aerobicsUserDescription" class="t-f-full form-control" required=""><?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->aboutUs;endif;?></textarea>
                                        <input type="hidden" name="otherId" id="otherId" value="<?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->tableAutoincrementId;endif;?>">
