                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="pilaId" id="pilaId" value="<?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->tableAutoincrementId;endif;?>">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-lg-12">
                            ...
                            <div class="col-md-6"> 
                                <div>
                                    ...
                                    <div class="col-lg-5"><label  for="typehead">Pilates Charges *</label></div>
