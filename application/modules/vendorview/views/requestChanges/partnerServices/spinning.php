                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="spinId" id="spinId" value="<?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->tableAutoincrementId;endif;?>">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-lg-12">
   				...
   				<?php if(isset($serviceData) && !empty($serviceData)):
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="icheck-inline">
                                            ...
                                            <input type="checkbox" value="Spinning Rope" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Spinning Rope", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities7" class="multiCheckbox">
                            ...
                            <div class="col-md-6"> 
                                <div class="">
                                    ...
                                    <div class="col-lg-5"><label  for="typehead">Spinning Charges *</label></div>
