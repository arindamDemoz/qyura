        ...
        <div class="col-md-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" id="serviceForm" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url(); ?>partners/kickboxing">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="tablesName" name="tablesName" value="kickboxing"/>
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>About Kick Boxing.  </label>
                                        ...
                                        <input type="hidden" name="kickId" id="kickId" value="<?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->kickId;endif;?>">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="award" name="awards" type="text" class="form-control" value="<?php if(isset($serviceData[0]->awards) && !empty($serviceData[0]->awards)):echo $serviceData[0]->awards;elseif(isset ($_POST['awards'])):echo $_POST['awards'];endif;?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="icheck-inline">
                                        <label>What are the amenities your centre have *</label><br>
                                            ...
                                            <input type="checkbox" value="Shower" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Shower", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities4" class="multiCheckbox">
                                            <label>Shower</label>
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5"><label  for="typehead">Kick Boxing Charges *</label></div>
                                    ...
                                    <div class="col-md-12 m-top-10">
                                        <div class="col-md-4 charges"><input type="checkbox" name="chargeType[]" id="perMonth" onclick="customShow('perMonth', 'perMonthDiv')" value="per_month" <?php if(isset($chargeType) && !empty($chargeType)):if(in_array("per_month", $chargeType)):echo"checked";endif;endif;?>/> Per Month</div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="perDayText1" tabindex="1" class="form-control" type="text" name="chargeAmountText" placeholder="Class Frequency" value="<?php if(isset($serviceData[0]->chargeAmountText) && !empty($serviceData[0]->chargeAmountText)):echo $serviceData[0]->chargeAmountText;endif;?>" >
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
