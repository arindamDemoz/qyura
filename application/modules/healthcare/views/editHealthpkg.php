                        ...
                        <div class="bg-white mi-form-section">
                            ...
                            <div class="clearfix m-t-20 p-b-20">
                                        ...
                                        <select class="selectpicker" data-width="100%" name="city" id="cityId">
                                            ...
                                            if (isset($allCities) && !empty($allCities)) {
                                                foreach ($allCities as $key => $val) {
                                                    ?>
                                                    <option <?php if(isset($editHealthcareData[0]->cityId) && $editHealthcareData[0]->cityId == $val->city_id){ echo 'selected=selected'; } ?> value="<?php echo $val->city_id; ?>"><?php echo $val->city_name; ?></option>
                                                <?php }
                                            }
                                            ?>
                                        </select>
                                ...
                                <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <select class="selectpicker" data-width="100%" name="miType" id="miType" onchange ="fetchHos(this.value, city.value)">
                                            ...
                                            <option <?php if(isset($editHealthcareData[0]->miType) && $editHealthcareData[0]->miType == 'Hospital'){ echo 'selected=selected'; } ?>>Hospital</option>
                                            <option <?php if(isset($editHealthcareData[0]->miType) && $editHealthcareData[0]->miType == 'Diagnostic'){ echo 'selected=selected'; } ?>>Diagnostic</option>
                                        </select>
                                           ...
                                           <?php
                                            if (isset($miData) && !empty($miData)) {
                                                foreach ($miData as $key => $val) {
                                                    ?>
                                                    <option <?php if(isset($editHealthcareData[0]->miId) && $editHealthcareData[0]->miId == $val->miId){ echo 'selected=selected'; } ?> value="<?php echo $val->miId; ?>"><?php echo $val->miName; ?></option>
                                                <?php }
                                            }
                                            ?>
                                        </select>
                                ...
                                <article class="clearfix m-t-10 ">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control disabled" id="packageId" name="packageId" type="disabled" required="" aria-required="true" placeholder="ACM304" value="<?php echo $editHealthcareData[0]->healthpkgId;?>" disabled="disabled">
                                ...
                                <article class="clearfix m-t-10">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input class="form-control " id="bestPrice" type="text" name="bestPrice" required="" placeholder="9000" onkeypress="return isNumberKey(event)" value="<?php echo $editHealthcareData[0]->bp;?>">
                                ...
                                <article class="form-group m-lr-0">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        ...
                                        <aside class="row">
                                            ...
                                            <?php if($editHealthcareData[0]->test != ''){
                                                 $testinclude=explode('|',$editHealthcareData[0]->test);
                                            if(!empty($testinclude)){
                                                foreach($testinclude as $key=>$value){
                                                   echo '<input type="text" class="form-control" name="testIncluded[]" id="hospitalServices_serviceName1" placeholder="Give Test Name" maxlength="200" value='.$value.' />';
                                                }
                                            }
                                          }  
                                   ?>
