            ...
            <div id="forgotDiv">
                <form class="m-t" role="form" action="<?php if($this->uri->segment(1) == "forgot"){ echo site_url('/forgot/forgotPassword'); }?>" method="POST">
                    <div class="form-group">
                        <input type="email" class="form-control" placeholder="Username" required="" name="forgotEmail" onkeyup="err();">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary block full-width m-b">Forgot</button>
                </form>
