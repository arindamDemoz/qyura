        ...
        <div class="col-md-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" id="serviceForm" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url(); ?>/partners/gym">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="gymId" id="gymId" value="<?php if(isset($serviceData) && !empty($serviceData)):echo $serviceData[0]->gymId;endif;?>">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>What are the amenities your centre have *</label><br>
                                            ...
                                            <input type="checkbox" value="AC" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("AC", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                            <label>AC</label>
                                            ...
                                            <input type="checkbox" value="Spa" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Spa", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                            <label>Spa</label>
                                            ...
                                            <input type="checkbox" value="Wi-Fi" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Wi-Fi", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                            <label>Wi-Fi</label>
                            ...
                            <div class="col-md-6"> 
                                <div>
                                    ...
                                    <div class="col-lg-12">
                                        <label  for="typehead">Gym Charges *</label>
                                    </div>
