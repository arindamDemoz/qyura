                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="icheck-inline">
                                            ...
                                            <input type="checkbox" value="Nutrition Scientists" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Nutrition Scientists", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Nutrition Scientists</label>
                                            
                                            <input type="checkbox" value="Public Health Nutritionist" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Public Health Nutritionist", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Public Health Nutritionist</label>

                                            <input type="checkbox" value="Clinical Dietician" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Clinical Dietician", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Clinical Dietician</label>

                                            <input type="checkbox" value="Community Dietician" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Community Dietician", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Community Dietician</label>

                                            <input type="checkbox" value="Foodservice Dietician" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Foodservice Dietician", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Foodservice Dietician</label>

                                            <input type="checkbox" value="Gerontological Dietician" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Gerontological Dietician", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Gerontological Dietician</label>

                                            <input type="checkbox" value="Research Dietician" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Research Dietician", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Research Dietician</label>

                                            <input type="checkbox" value="Administrative Dietician" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Administrative Dietician", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Administrative Dietician</label>

                                            <input type="checkbox" value="Business Dietician" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Business Dietician", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
                                            <label>Business Dietician</label>

                                            <input type="checkbox" value="Consultant Dietician" <?php if(isset($serviceData) && !empty($serviceData) && is_array($dieticianType)):if(in_array("Consultant Dietician", $dieticianType)):echo"checked";endif;endif;?> name="dieticianType[]" id="dieticianType" class="multiCheckbox">
