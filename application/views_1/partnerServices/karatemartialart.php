                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="icheck-inline">
                                            ...
                                            <input type="checkbox" value="Medical Aid" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Medical Aid", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="icheck-inline">
                                            ...
                                            <input type="checkbox" value="Shotokan" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Shotokan", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Shotokan – Ryu</label>
                                                
                                            <input type="checkbox" value="Contemporary" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Contemporary", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Contemporary</label>

                                            <input type="checkbox" value="Chito" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Chito", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Chito – Ryu</label>
                                            
                                            <input type="checkbox" value="Shito" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Shito", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Shito – Ryu</label>

                                            <input type="checkbox" value="Goju" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Goju", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Goju – Ryu</label>

                                            <input type="checkbox" value="Wado" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Wado", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Wado – Ryu</label>

                                            <input type="checkbox" value="Shorin" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Shorin", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Shorin – Ryu</label>

                                            <input type="checkbox" value="Uechi" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Uechi", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Uechi – Ryu</label>

                                            <input type="checkbox" value="Shuri" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Shuri", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Shuri – Ryu</label>

                                            <input type="checkbox" value="Kyokushinkai" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Kyokushinkai", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Kyokushinkai</label>

                                            <input type="checkbox" value="Budokan" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Budokan", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Budokan</label>

                                            <input type="checkbox" value="Aikido" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Aikido", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Aikido</label>

                                            <input type="checkbox" value="Brazilian" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Brazilian", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Brazilian Jiu-Jitsu (BJJ)</label>

                                            <input type="checkbox" value="Judo" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Judo", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Judo</label>

                                            <input type="checkbox" value="Karate" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Karate", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Karate</label>

                                            <input type="checkbox" value="Krav Maga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Krav Maga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Krav Maga</label>

                                            <input type="checkbox" value="Kung Fu" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Kung Fu", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Kung Fu</label>

                                            <input type="checkbox" value="Mixed" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Mixed", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Mixed Martial Arts (MMA)</label>

                                            <input type="checkbox" value="Muay" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Muay", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Muay Thai</label>

                                            <input type="checkbox" value="Taekwondo" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Taekwondo", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Taekwondo</label>

                                            <input type="checkbox" value="Tang" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Tang", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
