                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="icheck-inline">
                                            ...
                                            <input type="checkbox" value="Yoga Mats" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Yoga Mats", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Which categories of Yoga do you teach *</label><br>
                                            ...
                                            <input type="checkbox" value="Ashtanga Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Ashtanga Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Ashtanga Yoga</label>
                                            
                                            <input type="checkbox" value="Bikram Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Bikram Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Bikram Yoga</label>
                                            
                                            <input type="checkbox" value="Hatha Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Hatha Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Hatha Yoga</label>
                                            
                                            <input type="checkbox" value="Kriya Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Kriya Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Kriya Yoga</label>
                                            
                                            <input type="checkbox" value="Iyenger Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Iyenger Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Iyenger Yoga</label>
                                            
                                            <input type="checkbox" value="Kundalini Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Kundalini Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Kundalini Yoga</label>
                                            
                                            <input type="checkbox" value="Raja Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Raja Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Raja Yoga</label>
                                            
                                            <input type="checkbox" value="Power Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Power Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
                                            <label>Power Yoga</label>
                                            
                                            <input type="checkbox" value="Thai Yoga" <?php if(isset($serviceData) && !empty($serviceData) && is_array($categories)):if(in_array("Thai Yoga", $categories)):echo"checked";endif;endif;?> name="categories[]" id="categories" class="multiCheckbox">
