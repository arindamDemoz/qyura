                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="icheck-inline">
                                            ...
                                            <input type="checkbox" value="Clinical" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Contemporary", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                            <label>Clinical</label>

                                            <input type="checkbox" value="Mat" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Mat", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                            <label>Mat</label>

                                            <input type="checkbox" value="Small props" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Small props", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                            <label>Small props</label>

                                            <input type="checkbox" value="Power" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Power", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
                                            <label>Power</label>

                                            <input type="checkbox" value="Reformer style" <?php if(isset($serviceData) && !empty($serviceData) && is_array($amenities)):if(in_array("Reformer style", $amenities)):echo"checked";endif;endif;?> name="amenities[]" id="amenities" class="multiCheckbox">
