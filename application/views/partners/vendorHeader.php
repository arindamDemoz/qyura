...
<?php if($this->uri->segment(1) == "partners" ){ 
      ...
      || $this->uri->segment(4) == "zumba"                  || $this->uri->segment(4) == "others"                                      || $this->uri->segment(4) == "massages"               || $this->uri->segment(2) == "aerobics" 
      ...
      || $this->uri->segment(4) == "others"                 || $this->uri->segment(2) == "massages"       ){?>    
    <div id="wrapper"> 
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(2)=="vendorServices") ? 'active' : "" ;?>">
                            <a href="<?php echo site_url(); ?>partners/vendorServices"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</a>
                    </li>
<!--                    <li class="<?php if($this->uri->segment(1) == "partners" ){ 
                        if($this->uri->segment(4) == "aerobics"               || $this->uri->segment(4) == "crossfunctional"                             || $this->uri->segment(4) == "dance"                  || $this->uri->segment(4) == "dietitiannutritionist"                       || $this->uri->segment(4) == "fitnessstudio"          || $this->uri->segment(4) == "gym"                                         || $this->uri->segment(4) == "karatemartialart"       || $this->uri->segment(4) == "kickboxing"                                  || $this->uri->segment(4) == "nutritionist"           || $this->uri->segment(4) == "pilates"                                     || $this->uri->segment(4) == "spinning"               || $this->uri->segment(4) == "swimming"                                    || $this->uri->segment(4) == "yoga"                   || $this->uri->segment(4) == "zumba"                                       || $this->uri->segment(4) == "others"                 || $this->uri->segment(4) == "massages"
                        || $this->uri->segment(2) == "aerobics" 
                        || $this->uri->segment(2) == "crossfunctional"        || $this->uri->segment(2) == "dance"
                        || $this->uri->segment(2) == "dietitiannutritionist"  || $this->uri->segment(2) == "fitnessstudio"  
                        || $this->uri->segment(2) == "gym"                    || $this->uri->segment(2) == "karateMartialart"  
                        || $this->uri->segment(2) == "kickboxing"             || $this->uri->segment(2) == "pilates"         
                        || $this->uri->segment(2) == "spinning"               || $this->uri->segment(2) == "swimming"        
                        || $this->uri->segment(2) == "yoga"                   || $this->uri->segment(2) == "zumba"    
                        || $this->uri->segment(2) == "others"                 || $this->uri->segment(2) == "massages"
                        ){echo "active";}}?>">
                        <a href="#"><i class="fa fa-th-list"></i><span class="nav-label">Services</span><span class="fa arrow"></span></a>
                    ...
                    <?php }
                    if (in_array("Massages", $servicesArray)){ ?>
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="massages") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/massages"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Massages</span></a>
                    </li>
...
<!--                    </ul>
                    ...
                    <li class="">
                        <a href="#"><i class="fa fa-th-list"></i><span class="nav-label">Trainers</span></a>
                    </li>
                    <li class="">
                        <a href="#"><i class="fa fa-th-list"></i><span class="nav-label">Consumers</span></a>
                    </li>
                    <li class="">
                        <a href="#"><i class="fa fa-th-list"></i><span class="nav-label">Transactions</span></a>
                    </li>
                    <li class="">
                        <a href="#"><i class="fa fa-th-list"></i><span class="nav-label">Staff Management</span></a>
                    </li>
