                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="centerAddress" class="form-control required" placeholder="For home and centre with different address separate by a comma" id="centerAddress" value="<?php echo set_value('centerAddress'); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
