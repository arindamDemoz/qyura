                                ...
                                <form role="form" id="requestCallback" method="POST" action="#" enctype="multipart/form-data" >
                                    <div class="row">
                                        <div class="col-md-10 col-md-offset-1">
                                            ...
                                            <div style="display:none;position:absolute;top:42%;left:45%;padding:2px;" class="loader" >
                                                <img src="<?php echo base_url(); ?>/inspinia/loader/loader1.gif" alt="Loader">
                                            </div>
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="col-xs-12 m-top-20 text-center">
                            ...
                            <form class="form-inline mailchimp  wow zoomIn" role="form" action="#" id="emilList" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg m-top-10" id="aass"><i class="fa fa-hand-o-up "></i>Be the First to Know<img src="<?php echo base_url(); ?>assest/img/star-1.png"></button>
