...
<body>
<?php if($this->uri->segment(1) == "super" ){ 
      if($this->uri->segment(2) == "superServices"         || $this->uri->segment(4) == "aerobics" 
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="crossfunctional") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/crossfunctional"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Services</span></a>
                    </li>
                    <?php }
                    if (in_array("Dance", $servicesArray)){ ?>
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="dance") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/dance"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Vendor Category Management
</span></a>
                    </li>
                    <?php }
                    ...
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="dietitiannutritionist") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/dietitiannutritionist"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Vendor Management</span></a>
                    </li>
                    <?php }
                    ...
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="fitnessstudio") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/fitnessstudio"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Users</span></a>
                    </li>
                    <?php }
                    if (in_array("GYM", $servicesArray)){ ?>
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="gym") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/gym"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Membership Plan</span></a>
                    </li> 
                    <?php }
                    ...
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="karatemartialart") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/karatemartialart"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Transactions</span></a>
                    </li>
                    <?php }
                    if (in_array("Kick Boxing", $servicesArray)){ ?>
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="kickboxing") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/kickboxing"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Staff Management</span></a>
                    </li>
                    <?php }
                    if (in_array("Pilates", $servicesArray)){ ?>
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="pilates") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/pilates"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">App Users Analytics</span></a>
                    </li>
                    <?php }
                    if (in_array("Spinning", $servicesArray)){ ?>
                    <li class="<?php echo ($this->uri->segment(1)=="partners" &&  $this->uri->segment(4)=="spinning") ? 'active' : "" ;?>" >
                        <a href="<?php echo site_url("partners/vendorCustomView")."/".$vendorId."/spinning"; ?>"><i class="fa fa-th-list"></i> <span class="nav-label">Profile</span></a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li>
                            <a href="<?php echo site_url('/super/logout'); ?>">
